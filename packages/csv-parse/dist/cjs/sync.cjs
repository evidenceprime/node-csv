...
var normalize_options = function normalize_options(opts) {
  ...
  if (options.comment_no_infix === undefined || options.comment_no_infix === null || options.comment_no_infix === false) {
    ...
    throw new CsvError('CSV_INVALID_OPTION_COMMENT', ['Invalid option comment_no_infix:', 'value must be a boolean,', "got ".concat(JSON.stringify(options.comment_no_infix))], options);
  }
